...
export PACKAGES="clang-8 llvm-8 python3-zmq qtbase5-dev qttools5-dev-tools libevent-dev bsdmainutils libboost-system-dev libboost-filesystem-dev libboost-test-dev libboost-thread-dev libgmp-dev libdb5.3++-dev libminiupnpc-dev libzmq3-dev libqrencode-dev"
