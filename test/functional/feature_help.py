...
"""Verify that starting riecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start riecoin with -h for help text")
        ...
        self.log.info("Start riecoin with -version for version information")
        ...
        self.log.info("Start riecoind with -fakearg to make sure it does not start")
