...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # This will raise an exception for attempting to get the private key of an invalid Riecoin address
        assert_raises_rpc_error(-5, "Invalid Riecoin address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Riecoin address
        ...
        assert_raises_rpc_error(-5, "Invalid address", self.nodes[0].getaddressinfo, "TSRKxXQ6qNucGP8cPtdjxKJvH8FS683fL6")
