...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # In Riecoin, Blocks > 15 s in the future are rejected, but in RegTest, this is reverted to the Bitcoin's 2 h as the stricter check would require to rewrite a lot of tests
