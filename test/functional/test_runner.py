...
BASE_SCRIPTS = [
    ...
    # 'feature_segwit.py', # Needs adjustments for Bech32/Bech32M. Should no longer test preactivation.
    ...
    # 'wallet_txn_clone.py --segwit', # Works if setting output_type to "bech32" or "bech32m"
    'rpc_getchaintips.py',
    'rpc_misc.py',
    'interface_rest.py',
