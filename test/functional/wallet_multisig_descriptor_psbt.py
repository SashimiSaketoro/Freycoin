...
class WalletMultisigDescriptorPSBTTest(BitcoinTestFramework):
    ...
    def _get_xpub(wallet, internal):
        ...
        descriptor = next(filter(lambda d: d["desc"].startswith("wpkh(") and d["internal"] == internal, wallet.listdescriptors()["descriptors"]))
        ...
        return descriptor["desc"].split("wpkh(")[1].split(")")[0]
