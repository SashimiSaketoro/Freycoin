...
class WalletSendTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-8, "Use fee_rate (rie/vB) instead of feeRate", w0.send, {w1.getnewaddress(): 1}, 6, "conservative", 1, {"feeRate": 0.01})
        ...
        for mode in ["economical", "conservative", "RIC/kb", "rie/b"]:
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, fee_rate=0.99999999,
            expect_error=(-4, "Fee rate (0.999 rie/vB) is lower than the minimum fee rate setting (1.000 rie/vB)"))
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, fee_rate=0,
            expect_error=(-4, "Fee rate (0.000 rie/vB) is lower than the minimum fee rate setting (1.000 rie/vB)"))
