...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_riecoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_riecoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_riecoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: riecoin:")) != -1);
