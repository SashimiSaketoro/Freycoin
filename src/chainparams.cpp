...
public:
    CMainParams() {
        ...
        consensus.TaprootHeight = 1536768; // Activates around July 1 in case BIP9 activation fails
...
public:
    CTestNetParams() {
        ...
        consensus.TaprootHeight = 2147483647; // Already activated in Testnet
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        consensus.TaprootHeight = 2147483647; // Unused
