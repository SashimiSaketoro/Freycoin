...
BOOST_FIXTURE_TEST_CASE(util_ArgsMerge, ArgsMergeTestingSetup)
{
    ...
    //
    //   ARGS_MERGE_TEST_OUT=results.txt ./test_riecoin --run_test=util_tests/util_ArgsMerge
    //
...
BOOST_FIXTURE_TEST_CASE(util_ChainMerge, ChainMergeTestingSetup)
{
    ...
    // If check below fails, should manually dump the results with:
    //
    //   CHAIN_MERGE_TEST_OUT=results.txt ./test_riecoin --run_test=util_tests/util_ChainMerge
    //
    // And verify diff against previous results to make sure the changes are expected.
    //
    // Results file is formatted like:
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("riecoin"), "Riecoin");
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "RVffQGsSD5b7X8tSkMNVoR1szkK9Qe1396", // PrivKey 568531539eada35fec620f058e293dc170d1b4726c67eb471502221130ccefaa
            "H/TAQFCrV8ACDGqBoI1X3eLMY2UiCsxcyrsd+p6LLqNjQhpELGyVL3ZXTbrZbPkkaXf8Zfnq8LSt58qzjeIFEdo=",
            "Trust me"),
        MessageVerificationResult::OK);
}
