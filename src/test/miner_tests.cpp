...
*/BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    // Therefore, load 16 blocks :)
    //static_assert(sizeof(blockinfo) / sizeof(*blockinfo) == 16, "Should have 16 blocks to import");
    int baseheight = 0;
    ...
    for (unsigned int i = 0; i < sizeof(blockinfo)/sizeof(*blockinfo); ++i)
    {
        CBlock *pblock = &pblocktemplate->block; // pointer for convenience
        {
            ...
            pblock->nResult = UintToArith256(blockinfo[i].nResult);
        }
